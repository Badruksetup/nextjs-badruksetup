    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="px-2 md:px-0 text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-white animate-in slide-in-from-bottom duration-1000">
          ...
          <p className="text-lg sm:text-lg md:text-xl text-gray-300 mb-12 max-w-2xl mx-auto animate-in slide-in-from-bottom duration-1000 delay-200">
